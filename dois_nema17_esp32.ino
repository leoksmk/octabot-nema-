...
const unsigned long INTERVALO_MIN   = 150;  // teto de velocidade (menor = mais rapido; se travar/chiar, suba p/ 180-220)
...
unsigned long intervaloCruzeiro = 1325; // = 50% do slider (map 0-100% -> MAX..MIN)
